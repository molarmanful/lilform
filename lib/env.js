...
function () {
  ...
  _createClass(Cell, [{
    ...
    value: function decide(food, cell) {
      ...
      } else this.move(0, 0); // duplicate


      if (this.energy >= 2 * this.base) this.dup(); // reproduce

      if (near && near.constructor == Cell && this.energy < near.energy) this.rep(near); // find food
